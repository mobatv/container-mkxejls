...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mkxejls.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mkxejls.containers.anotherwebservice.com/
...
```
git clone git@github.com:mobatv/container-mkxejls.git
cd container-mkxejls
```
...
```
docker attach container-mkxejls
```
